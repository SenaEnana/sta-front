    ...
    <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-amber-200 to-indigo-300 shadow z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center p-4">
            ...
            <ul className="hidden md:flex space-x-6">
                <li><a href="#hero" className="text-black hover:text-amber-600">Home</a></li>
            ...
            <div className="me-1">
                <button
                    className="bg-amber-500 text-black font-bold rounded hover:bg-amber-600 p-2 me-1 cursor-pointer">
